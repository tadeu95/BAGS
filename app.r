...
grades2<-function(groups){
  ...
  taxon9$bold_bin_per_species=as.numeric(taxon9$bold_bin_per_species)
  taxon9$bold_species_per_bin=as.numeric(taxon9$bold_species_per_bin)
  taxon19<-taxon9 %>%
  ...
  taxon19$bold_bin_per_species=NULL
